...
Profile.prototype = Object.create({}, {
    ...
    dontShowAgain: { get: function () { return element(by.css('[for="shell-dismissHelp"]')); }},
    ...
    changeCss: {
        value: function () {
            ...
            browser.driver.executeScript("arguments[0].style.height = '239px'; ", control)
                .then(function () { });
        }
    },

    changePwd: { value: function (newpass, oldpass) { this.txtNewPassword.clear();
